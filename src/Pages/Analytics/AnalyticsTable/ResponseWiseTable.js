...
// import { Tabs, Table, Avatar, Typography, Input, Row, Col, Tag } from "antd";
...
// const TableContent = ({ data, keyName, sortConfig, onSort, searchItem }) => {
//   const rows = useMemo(
//     () =>
//       data
//         .filter((item) =>
...
//   const { analyticsData, searchItemResponse } = useSelector(
